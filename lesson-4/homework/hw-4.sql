...
--WHERE f.referenced_object_id = OBJECT_ID('Employees');
...
--Task9
Select distinct Category, Productsname
from Products;
--Task10
Select distinct Category, Productsname
from Products
...
FROM Employees;
--Task22
SELECT DISTINCT Category, ProductsName, Price
FROM products
WHERE Price > 50;
--Task23
SELECT *
